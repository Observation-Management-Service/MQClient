...
def test_message_generator(mock_ap: Any) -> None:
...
def test_message_generator_nack(mock_ap: Any) -> None:
    ...
    with pytest.raises(Exception):
        _ = list(apachepulsar.message_generator(q, propagate_error=True))
